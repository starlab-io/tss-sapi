...
pub enum TpmAlgorithm {
    RSA = sys::ALG_RSA_VALUE as isize,
    SHA1 = sys::ALG_SHA1_VALUE as isize,
    HMAC = sys::ALG_HMAC_VALUE as isize,
    AES = sys::ALG_AES_VALUE as isize,
    MGF1 = sys::ALG_MGF1_VALUE as isize,
    KEYEDHASH = sys::ALG_KEYEDHASH_VALUE as isize,
    XOR = sys::ALG_XOR_VALUE as isize,
    SHA256 = sys::ALG_SHA256_VALUE as isize,
    SHA384 = sys::ALG_SHA384_VALUE as isize,
    SHA512 = sys::ALG_SHA512_VALUE as isize,
    NULL = sys::ALG_NULL_VALUE as isize,
    SM3_256 = sys::ALG_SM3_256_VALUE as isize,
    SM4 = sys::ALG_SM4_VALUE as isize,
    RSASSA = sys::ALG_RSASSA_VALUE as isize,
    RSAES = sys::ALG_RSAES_VALUE as isize,
    RSAPSS = sys::ALG_RSAPSS_VALUE as isize,
    OAEP = sys::ALG_OAEP_VALUE as isize,
    ECDSA = sys::ALG_ECDSA_VALUE as isize,
    ECDH = sys::ALG_ECDH_VALUE as isize,
    ECDAA = sys::ALG_ECDAA_VALUE as isize,
    SM2 = sys::ALG_SM2_VALUE as isize,
    ECSCHNORR = sys::ALG_ECSCHNORR_VALUE as isize,
    ECMQV = sys::ALG_ECMQV_VALUE as isize,
    KDF1_SP800_56A = sys::ALG_KDF1_SP800_56A_VALUE as isize,
    KDF2 = sys::ALG_KDF2_VALUE as isize,
    KDF1_SP800_108 = sys::ALG_KDF1_SP800_108_VALUE as isize,
    ECC = sys::ALG_ECC_VALUE as isize,
    SYMCIPHER = sys::ALG_SYMCIPHER_VALUE as isize,
    CAMELLIA = sys::ALG_CAMELLIA_VALUE as isize,
    CTR = sys::ALG_CTR_VALUE as isize,
    OFB = sys::ALG_OFB_VALUE as isize,
    CBC = sys::ALG_CBC_VALUE as isize,
    CFB = sys::ALG_CFB_VALUE as isize,
    ECB = sys::ALG_ECB_VALUE as isize,
}
